...
Replace this section with the supported versions for `mcpmock`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `mcpmock` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in mcpmock.
